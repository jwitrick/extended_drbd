...
default[:drbd][:primary][:short_hostname] = "<result of command 'hostname'>"

default[:drbd][:primary][:ip] = ""

default[:drbd][:secondary][:short_hostname] = "<result of command 'hostname'>"

default[:drbd][:secondary][:ip] = ""
